        ...
        json.dumps(
            {
                ...
                "vintage_isolation": (
                    "the magnitude and RMSE gates compare the refitted extension with the "
                    "revised-history baseline, so revised historical values do enter those "
                    "comparisons, as the quantity the extension is measured against. What "
                    ...
                    "The frozen sign gate retains its registered comparator, the locked "
                    "baseline, and is therefore the one gate in which two vintages meet; a "
                    "same-vintage sign comparison is reported alongside it as a "
                    "non-decisional diagnostic. The publication-era against current-vintage "
                    "effect is reported separately as the locked-against-revised comparison"
                ),
                "replication_status": "documented_reconstruction",
            },
            indent=2,
